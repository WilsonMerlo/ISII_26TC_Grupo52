  ...
  const manejarEnvio = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(
          errorData.mensaje || "Error al crear la cuenta. Revisa los datos.",
        );
      }
    } catch (err) {
      setError(
        "Error de red. Verificá que el Visual Studio Morado esté corriendo.",
      );
    }
  };
  ...
  return (
    <div style={estilos.fullPageWrap}>
      <div style={estilos.splitContainer}>
        ...
        <div style={estilos.leftColumn}>
          ...
          <h1 style={estilos.heroTitle}>
            Tu espacio para el{" "}
            <span style={estilos.textHighlight}>trabajo profundo.</span>
          </h1>
          <p style={estilos.heroSubtitle}>
            Únete a una comunidad diseñada para minimizar el ruido digital y
            potenciar tu enfoque cognitivo.
          </p>
        ...
        <div style={estilos.rightColumn}>
          <form style={estilos.card} onSubmit={manejarEnvio}>
            ...
            <p style={estilos.formSubtitle}>
              Empieza hoy tu camino hacia la productividad consciente.
            </p>
      ...
      <footer style={estilos.footer}>
        © 2026 StudIA StudIA. Diseñado para Deep Work. • Privacy Policy • Terms
        of Service • Help Center
      </footer>
    </div>
  );
};
